...
Gem::Specification.new do |spec|
  ...
  spec.summary     = 'Maven integration for RubyMotion Android projects'
  spec.description = "motion-maven allows RubyMotion Android projects to have access to the Maven dependency manager."
